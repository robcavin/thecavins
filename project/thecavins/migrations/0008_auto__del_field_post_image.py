...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('thecavins_post_images', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('post', models.ForeignKey(orm['thecavins.post'], null=False)),
            ('image', models.ForeignKey(orm['thecavins.image'], null=False))
        ))
        db.create_unique('thecavins_post_images', ['post_id', 'image_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('thecavins_post_images')
    ...
    models = {
        ...
        'thecavins.post': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'max_length': '512', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'images': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'posts'", 'symmetrical': 'False', 'to': "orm['thecavins.Image']"}),
