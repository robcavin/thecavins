...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('thecavins_userprofile', 'nickname',
                      self.gf('django.db.models.fields.CharField')(default='Nickname', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.nickname'
        db.delete_column('thecavins_userprofile', 'nickname')
